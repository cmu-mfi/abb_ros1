...
Eigen::Matrix4d AB_Interface::_FK(const VectorJd& q, const Eigen::MatrixXd& DH, const Eigen::Matrix4d& base_frame, const bool& joint_rad)
{
    Eigen::Matrix3d R;
...
Eigen::MatrixXd AB_Interface::loadFromFile_(std::string file_path, std::string key)
{
	Eigen::MatrixXd data;
