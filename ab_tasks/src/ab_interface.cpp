...
AB_Interface::AB_Interface(std::string group_name, ros::NodeHandle &nh_)
    : move_group_(group_name), 
    go_to_pose_as_(nh_, "ab_go_to_pose", boost::bind(&AB_Interface::goToPoseCallback, this, _1), false), 
    go_to_pose_async_as_(nh_, "ab_go_to_pose_async", boost::bind(&AB_Interface::goToPoseAsyncCallback, this, _1), false), 
    go_to_joints_as_(nh_, "ab_go_to_joints", boost::bind(&AB_Interface::goToJointsCallback, this, _1), false),
    execute_cartesian_trajectory_as_(nh_, "ab_execute_cartesian_trajectory_action", boost::bind(&AB_Interface::executeCartesianTrajectoryCallback, this, _1), false)
{
	...
	std::string current_dir = ros::package::getPath("ab_tasks"); 
	std::string robot_config_file = current_dir + "/config/irb1300.json";
	...
	check_moving_sub_ = nh_.subscribe("check_moving", 1, &AB_Interface::checkMoving, this);
	trajectory_status_sub_ = nh_.subscribe("execute_trajectory/status", 1, &AB_Interface::checkTrajStatus, this);
	joint_states_sub_ = nh_.subscribe("joint_states", 1, &AB_Interface::jointStatesCallback, this);

	//ROSTOPIC PUBLISHERS 
	tool0_pose_pub_ = nh_.advertise<geometry_msgs::PoseStamped>("tool0_pose", 1);

    //SERVICE SERVERS
	getPose_server_ = nh_.advertiseService("ab_get_pose", &AB_Interface::getPose, this);
	setJoints_server_ = nh_.advertiseService("ab_set_joints", &AB_Interface::setJoints, this);
	setPose_server_ = nh_.advertiseService("ab_set_pose", &AB_Interface::setPose, this);
	executeTrajectory_server_ = nh_.advertiseService("ab_execute_trajectory", &AB_Interface::executeTrajectory, this);
	stopTrajectory_server_ = nh_.advertiseService("ab_stop_trajectory", &AB_Interface::stopTrajectory, this);
	executeCartesianTraj_server_ = nh_.advertiseService("ab_execute_cartesian_trajectory", &AB_Interface::executeCartesianTrajectory, this);
	executeCartesianTrajAsync_server_ = nh_.advertiseService("ab_execute_cartesian_trajectory_async", &AB_Interface::executeCartesianTrajectory, this);
}

bool AB_Interface::getPose(ab_msgs::GetPose::Request &req, ab_msgs::GetPose::Response &res){
...
bool AB_Interface::setPose(ab_msgs::SetPose::Request &req, ab_msgs::SetPose::Response &res){
...
bool AB_Interface::setJoints(ab_msgs::SetJoints::Request &req, ab_msgs::SetJoints::Response &res){
...
bool AB_Interface::executeTrajectory(moveit_msgs::ExecuteKnownTrajectory::Request &req, moveit_msgs::ExecuteKnownTrajectory::Response &res){
...
bool AB_Interface::stopTrajectory(std_srvs::Trigger::Request &req, std_srvs::Trigger::Response &res){
...
bool AB_Interface::executeCartesianTrajectory(ab_msgs::ExecuteCartesianTrajectory::Request &req, ab_msgs::ExecuteCartesianTrajectory::Response &res){
	ros::AsyncSpinner async_spinner(1);
	async_spinner.start();
...
bool AB_Interface::executeCartesianTrajectoryAsync(ab_msgs::ExecuteCartesianTrajectory::Request &req, ab_msgs::ExecuteCartesianTrajectory::Response &res){
	ros::AsyncSpinner async_spinner(1);
	async_spinner.start();
...
void AB_Interface::goToJointsCallback(const ab_msgs::GoToJointsGoalConstPtr &goal){
	ros::AsyncSpinner async_spinner(1);
	async_spinner.start();
...
void AB_Interface::goToPoseCallback(const ab_msgs::GoToPoseGoalConstPtr &goal){
    ros::AsyncSpinner async_spinner(1);
	async_spinner.start();
...
void AB_Interface::goToPoseAsyncCallback(const ab_msgs::GoToPoseGoalConstPtr &goal){
        ros::AsyncSpinner async_spinner(1);
	async_spinner.start();
...
void AB_Interface::executeCartesianTrajectoryCallback(const ab_msgs::ExecuteCartesianTrajectoryGoalConstPtr & goal){
...
void AB_Interface::checkMoving(const sensor_msgs::JointState::ConstPtr &msg){
...
void AB_Interface::checkTrajStatus(const actionlib_msgs::GoalStatusArray::ConstPtr &msg){
    int len = msg->status_list.size();
	if (len != 0)
		traj_status_ = msg->status_list[len - 1];
}

void AB_Interface::jointStatesCallback(const sensor_msgs::JointState::ConstPtr& msg){
	// READ JOINT STATES
...
/** Private Methods */
	 ...
	 */
void AB_Interface::calculatePoseError_(const geometry_msgs::Pose &pose1, const geometry_msgs::Pose &pose2, double &position_error, double &orientation_error){
...
/**
	 ...
	 */
bool AB_Interface::planAndExecuteCartesianPath_(const std::vector<geometry_msgs::Pose> &waypoints, 
	 ...
	 *
	 */
bool AB_Interface::planAndExecutePose_(const geometry_msgs::Pose &pose, 
							double max_velocity_scaling_factor, double max_acceleration_scaling_factor,
