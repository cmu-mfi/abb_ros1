#ifndef _AB_INTERFACE_
#define _AB_INTERFACE_

#include <ros/ros.h>
#include <actionlib/server/simple_action_server.h>
#include <ros/package.h>
#include <ab_msgs/GoToPoseAction.h>
#include <ab_msgs/GoToJointsAction.h>
#include <ab_msgs/ExecuteCartesianTrajectoryAction.h>
#include <ab_msgs/GetPose.h>
#include <ab_msgs/GetPoseStamped.h>
#include <ab_msgs/SetPose.h>
#include <ab_msgs/SetJoints.h>
#include <ab_msgs/ExecuteCartesianTrajectory.h>
...
private:
    ...
    // ROS ACTION SERVERS 
    actionlib::SimpleActionServer<ab_msgs::GoToPoseAction> go_to_pose_as_;
	actionlib::SimpleActionServer<ab_msgs::GoToPoseAction> go_to_pose_async_as_;
	actionlib::SimpleActionServer<ab_msgs::GoToJointsAction> go_to_joints_as_;
	actionlib::SimpleActionServer<ab_msgs::ExecuteCartesianTrajectoryAction> execute_cartesian_trajectory_as_;

    //ROS ACTION MSGS FEEDBACKS/RESULTS
	ab_msgs::GoToPoseFeedback go_to_pose_feedback_;
	ab_msgs::GoToPoseResult go_to_pose_result_;
	ab_msgs::GoToPoseFeedback go_to_pose_async_feedback_;
	ab_msgs::GoToPoseResult go_to_pose_async_result_;
	ab_msgs::GoToJointsFeedback go_to_joints_feedback_;
	ab_msgs::GoToJointsResult go_to_joints_result_;
	ab_msgs::ExecuteCartesianTrajectoryFeedback execute_cartesian_trajectory_feedback_;
	ab_msgs::ExecuteCartesianTrajectoryResult execute_cartesian_trajectory_result_;
...
public:
	/**
	* @brief Constructor for the AB_Interface class.
	*
	...
	*/
	AB_Interface(std::string group_name, ros::NodeHandle &nh_);
	
	/**
	* @brief Callback function for the 'ab_get_pose' ROS service.
	*
	...
	*/
	bool getPose(ab_msgs::GetPose::Request &req, ab_msgs::GetPose::Response &res);

	/**
	* @brief Callback function for the 'ab_set_pose' ROS service.
	*
	...
	* @note This function uses an AsyncSpinner to ensure ROS callbacks remain active during blocking operations.
 	*/
	bool setPose(ab_msgs::SetPose::Request &req, ab_msgs::SetPose::Response &res);
	
	/**
	* @brief Callback function for the 'ab_set_joints' ROS service.
	*
	...
	*/
	bool setJoints(ab_msgs::SetJoints::Request &req, ab_msgs::SetJoints::Response &res);
	
	/**
	* @brief Callback function for the 'ab_execute_trajectory' ROS service.
	*
	...
	*/
	...
	/**
	* @brief Callback function for the 'ab_stop_trajectory' ROS service.
	*
	...
	*/
	...
	/**
	 * @brief Callback function for the 'ab_execute_cartesian_trajectory' ROS service.
	 *
	...
	*/
	bool executeCartesianTrajectory(ab_msgs::ExecuteCartesianTrajectory::Request &req, ab_msgs::ExecuteCartesianTrajectory::Response &res);
	
	/**
	 * @brief Callback function for the 'ab_execute_cartesian_trajectory_async' ROS service.
	 *
	 ...
	 *
	 */
	bool executeCartesianTrajectoryAsync(ab_msgs::ExecuteCartesianTrajectory::Request &req, ab_msgs::ExecuteCartesianTrajectory::Response &res);
	
	/**
	 * @brief Callback function for the 'ab_go_to_joints' action server.
	 *
	 ...
	 */
	void goToJointsCallback(const ab_msgs::GoToJointsGoalConstPtr &goal);

	/**
	 * @brief Callback function for the 'ab_go_to_pose' action server.
	 *
	 ...
	 *
	 */
	void goToPoseCallback(const ab_msgs::GoToPoseGoalConstPtr &goal);

	/**
	 * @brief Callback function for the 'ab_go_to_pose_async' action server.
	 *
	 ...
	 */
	void goToPoseAsyncCallback(const ab_msgs::GoToPoseGoalConstPtr &goal);	

	/**
	 * @brief Callback function for the 'ab_execute_cartesian_trajectory' action server.
	 *
	 ...
	 */
	void executeCartesianTrajectoryCallback(const ab_msgs::ExecuteCartesianTrajectoryGoalConstPtr & goal);
